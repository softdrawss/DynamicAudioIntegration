...
public class ZenithPlane : AudioPlane
{
    ...
    // Azimuth plane (fr radius)
    public bool useAzimuthRadius;
    ...
    protected override Vector3[] GetRayOrigins()
    {
        for (int i = 0; i < rays; i++)
        {
            ...
            origins[i] = transform.position + GetHorizontalDirection(currentAngle) * (useAzimuthRadius ? azimuthPlane.GetAzimuth() : offset /*azimuthPlane.GetAzimuth()*/);
        }
    ...
    public float GetZenith() { return _height; }
}
